...
public class Person {
	...
	public void calcPerson(){
		...
		List missBoard = new ArrayList<Integer>();
				...
				if(board % 2 != 1 && board < min_missboard){
					...
					if(((checkBoard(1 + n,board)=="no" && checkBoard(2,board)=="no")
						...
						do{
							...
							Method a_method = Person.class.getMethod(a_smethod,int.class,int.class);
							Method b_method = Person.class.getMethod(b_smethod,int.class,int.class);
							...
							//ちゃんと進めている場合、向きが変わっているかを進んだ座標から確認する
